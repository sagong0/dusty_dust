...
class StatModelAdapter extends TypeAdapter<StatModel> {
  ...
  StatModel read(BinaryReader reader) {
    ...
    return StatModel(
      ...
      gyeonggi: fields[3] as double,
      daejeon: fields[4] as double,
      gyeongbuk: fields[5] as double,
      sejong: fields[6] as double,
      gwangju: fields[7] as double,
      jeonbuk: fields[8] as double,
      gangwon: fields[9] as double,
      ulsan: fields[10] as double,
      jeonnam: fields[11] as double,
      seoul: fields[12] as double,
      busan: fields[13] as double,
      jeju: fields[14] as double,
      chungbuk: fields[15] as double,
      gyeongnam: fields[16] as double,
